...
class Copy_Wpmu_Posts {
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_action( 'copy_wpmu_posts_after_copy_to_destination', $plugin_admin, 'copy_wpmu_posts_copy_reorder_data', 10, 2 );
		$this->loader->add_action( 'transition_post_status', $plugin_admin, 'copy_wpmu_posts_update_hreflng_data', 10, 3 );
